...
public class Signature {
	...
	public void sign() throws IOException, SignatureException, InvalidKeyException, NoSuchAlgorithmException,
		...
		RSAPrivateKeySpec privateKeyRSA = new RSAPrivateKeySpec(new BigInteger(module), new BigInteger(privateKey));
